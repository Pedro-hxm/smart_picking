<?php
// Mensagem: Esta página exibe a tabela de estoque disponível para visualização.
$mensagem = "Visualize abaixo os itens disponíveis no estoque.";
?>
<!DOCTYPE html>
<html lang="pt-BR">
<head>
    ...
    <title>Smart Picking - Visualizar Estoque</title>
    <link rel="stylesheet" type="text/css" href="../css/visualizarEstoque.css" media="screen" />
</head>
<body>
    <div class="sidebar">
    ...
    <div class="main-content">
        <h1>Visualizar <span style="color: #87A5CB;">Estoque</span></h1>
